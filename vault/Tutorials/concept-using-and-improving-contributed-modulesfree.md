...
Start by [searching the module's issue queue on Drupal.org](https://www.drupal.org/project/issues/search) for existing discussions about the bug or feature you're interested in. It's always better to collaborate on existing solutions when one exists. If no issue exists, file a new one to start the conversation.
...
**Tip**: If the updated code from the issue queue works for your scenario (and you've tested and reviewed it) it is common to use a *patched version of a module* in production. [Patches can be applied using Composer](https://drupalize.me/tutorial/composer-configuration-drupal#toc-patching-c-0ghm0yp5).

### Submit a merge request

If you've developed a fix or enhancement, create a merge request and an issue in the queue. Follow Drupal's coding standards and provide clear, concise explanations of your changes, why you've made them, and how to test them. Learn more in [Create a merge request for an issue](https://www.drupal.org/community/contributor-guide/task/create-a-merge-request-for-an-issue).
...
Drupal's unique [contribution credit system](https://www.drupal.org/drupalorg/contribution-credit) recognizes both code and non-code contributions, providing visibility and acknowledgment to individuals and organizations contributing to Drupal. This system encourages participation and helps maintain the integrity of the Drupal project by ensuring contributions are meaningful and impactful.
...
- [Drupal Contributor Guide](https://www.drupal.org/contribute) (Drupal.org)
...
Next
[Concept: Contributing Your Custom Modules](/tutorial/concept-contributing-your-custom-modules?p=3247)
