...
- This guide is organized into topics; see [Section i.3, “Organization”](https://drupalize.me/tutorial/user-guide/preface-organization "i.3. Organization") for details. Many topics include a *Prerequisite knowledge* section, which lists other topics whose content knowledge is needed in order to understand the topic you are reading. Some background knowledge that is not covered in the guide is also assumed; see [Section i.2, “Audience and Goal”](https://drupalize.me/tutorial/user-guide/preface-audience "i.2. Audience and Goal") for details.
...
- The specifics of the site prerequisites relate to the scenario used throughout this guide of building a site for a farmers market (see [Section i.6, “Guiding Scenario”](https://drupalize.me/tutorial/user-guide/preface-scenario "i.6. Guiding Scenario") for details). You can adapt the tasks to your own scenario, but you will also need to remember the changes you made when deciding if your site satisfies the site prerequisites for a task.
- For all task topics after [Section 3.7, “Running the Interactive Installer”](https://drupalize.me/tutorial/user-guide/install-run "3.7. Running the Interactive Installer"), there is also an implicit prerequisite: you must have installed the latest stable version of the content management software on your site, and be logged in to a user account with sufficient permissions to do the task (such as the user account created when you installed your site, which automatically has full permissions).
...
- This guide demonstrates how to perform tasks using the administrative user interface, and wherever possible, also using the latest stable version of the Drush command-line tool (see [Section 3.3, “Concept: Additional Tools”](https://drupalize.me/tutorial/user-guide/install-tools "3.3. Concept: Additional Tools")). You can feel free to only use the administrative interface depending on your preference.
...
Previous
[i.4. Reporting Problems](/tutorial/user-guide/preface-reporting?p=2355)

Next
[i.6. Guiding Scenario](/tutorial/user-guide/preface-scenario?p=2355)
