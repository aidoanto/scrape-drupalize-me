...
2. Log in to [*Drupal.org*](https://www.drupal.org) (you will need to create a user account if you do not already have one).
3. Visit the [User Guide issues page on *Drupal.org*](https://www.drupal.org/project/issues/user_guide).
...
Next
[i.5. Conventions of the Guide](/tutorial/user-guide/preface-conventions?p=2355)
