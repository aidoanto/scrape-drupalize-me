...
![Screenshot of documentation for Checkbox class with annotation highlighted to show where it is on the page.](../assets/images/form_api-form-element-annotation.png)
...
![Screenshot showing documentation for checkbox element with custom properties highlighted](../assets/images/form-api_element-documentation-properties.png)
...
![Screenshot of the form generated by the code above showing the new checkbox and select elements](../assets/images/form-api_simple-form-with-extras.png)
