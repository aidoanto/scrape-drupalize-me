---
title: "Concept: Coding Standardsfree"
url: "https://drupalize.me/tutorial/concept-coding-standards?p=3246"
guide: "[[drupal-module-developer-guide]]"
order: 77
---

# Concept: Coding Standardsfree
...
The definitive guide for Drupal's coding standards is available on [Drupal.org](https://www.drupal.org/docs/develop/standards). The community discusses and evolves these standards in the [Coding Standards project](https://www.drupal.org/project/coding_standards).

Drupal employs PHP CodeSniffer (phpcs) with custom rules to lint code. For an introduction to using phpcs in your projects, see [Using PHP CodeSniffer with Drupal](https://drupalize.me/tutorial/lint-your-code-phpcodesniffer).

## Configure your IDE to warn you about coding standards

Most IDEs can be configured to warn you about coding standards violations in real-time and to automatically format code according to Drupal's standards. Learn how to [configure PhpStorm](https://www.jetbrains.com/help/phpstorm/drupal-support.html), or [Visual Studio Code](https://www.drupal.org/docs/develop/development-tools/editors-and-ides/configuring-visual-studio-code), or search for guides on setting up your IDE of choice.
...
- [Drupal Coding Standards](https://drupalize.me/topic/drupal-coding-standards) (Drupalize.Me)
- [Coding standards](https://www.drupal.org/docs/develop/standards) (Drupal.org)
...
Previous
[Concept: Writing Secure Code](/tutorial/concept-writing-secure-code?p=3246)
