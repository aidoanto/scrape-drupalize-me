...
We'll be working with the Anytown Farmers Market site, which we built in the [Drupal User Guide](https://drupalize.me/guide/drupal-user-guide). Our goal is to extend and enhance this site using custom modules, to fulfill project-specific requirements. We use a narrative approach, which we hope will help you better understand the real-world applications of module development in Drupal.
...
- You're familiar with the Anytown Farmers Market site that we covered in the [Drupal User Guide](https://drupalize.me/guide/drupal-user-guide).
...
[Let's get started](https://drupalize.me/tutorial/concept-what-are-modules).
...
Previous
[Audience and Approach](/tutorial/audience-and-approach?p=3233)
